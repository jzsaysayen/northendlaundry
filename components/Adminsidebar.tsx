...
import { WashingMachine, Users, BarChart3, ClipboardList, FileText, LayoutDashboard, Tags } from 'lucide-react';
...
export default function AdminSidebar({ userName, userEmail }: AdminSidebarProps) {
  ...
  const navItems = [
    ...
    { href: "/admin/manage-laundry", label: "Manage Laundry", icon: ClipboardList },
    { href: "/admin/manage-customers", label: "Manage Customers", icon: Users },
    { href: "/admin/manage-users", label: "Manage Users", icon: Users },
    { href: "/admin/analytics-report", label: "Analytics Report", icon: BarChart3 },
    { href: "/admin/audit-log", label: "Audit Log", icon: FileText },
    { href: "/admin/set-price", label: "Set Price", icon: Tags },
  ];
  ...
  return (
    <aside className="w-64 bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 flex flex-col h-screen sticky top-0">
      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-700 flex-shrink-0">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Admin Portal</p>
      </div>
